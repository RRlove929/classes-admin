<div style="text-align:center">
    <img src="distribution/images/logo.jpg" alt="在线防灾教育教育系统-开源版"/>
    <div>    
...
在线防灾教育教育系统（roncoo-education）是基于在线防灾教育网络多年的在线教育平台开发和运营经验打造出来的产品，致力于打造一个各行业都适用的分布式在线教育系统。系统采用前后端分离模式，前台采用vue.js为核心框架，后台采用Spring
...
<img src="distribution/images/gzh.png" alt="在线防灾教育开源-微信公众号" width="600"/>
</div>